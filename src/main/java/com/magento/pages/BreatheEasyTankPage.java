...
public class BreatheEasyTankPage {
    // variables
    // locators
    // constructor
    // actions
    ...
    private final By compareProductButton = By.xpath("/html/body/div[2]/header/div[2]/ul/li/a");

    // constructor
    public BreatheEasyTankPage(WebDriver driver){
        this.driver =driver;
    }
    // actions
    public BreatheEasyTankPage clickOnAddToCompare(){
        ElementActions.clickElement(driver,this.addToCompare);
        return this;
    }
    public BreatheEasyTankPage clickCompareProductButton(){
        ElementActions.clickElement(driver,this.compareProductButton);
        return this;
    }
    // validations
    public BreatheEasyTankPage assertSuccessMessage(){
